...
.cup {
  ...
  margin: 10px /* pomicanje šalice gore dolje */ 
  30px /* pomicanje šalice lijevo desno */
...
/* tanjurić - ispod šalice */
.saucer {
  margin: auto /* pomicanje tanjurića gore dolje */
  15px; /* pomicanje tanjurića lijevo desno */
  width: 150px;
  height: 40px;
  border-radius: 50%;
